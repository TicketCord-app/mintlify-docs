...
| `http://localhost:3000` | No: localhost and plain HTTP origins are rejected |
| `example.com` | No — missing protocol |
| `https://example.com/support` | Accepted, but stored as `https://example.com` (only the origin is kept) |
