...
### TC001 - Rate Limited {#tc001-rate-limited}
...
### TC002 - Permission Denied {#tc002-permission-denied}
...
### TC004 - Resource Not Found {#tc004-resource-not-found}
...
### TC005 - Discord API Error {#tc005-discord-api-error}
...
**Solution:** Wait a few minutes and try again. If the issue persists, check [Discord Status](https://discordstatus.com) for outages.

---

### TC008 - Failed to Fetch Resources {#tc008-failed-to-fetch-resources}
...
### TC009 - Invalid Selection {#tc009-invalid-selection}
...
### TC010 - Unknown Action {#tc010-unknown-action}
...
### TC011 - Configuration Not Found {#tc011-configuration-not-found}
...
### TC012 - Input Validation Error {#tc012-input-validation}
