...
<Info>
  AI features require a **Pro** or **Enterprise** plan. [View pricing](https://ticketcord.com/pricing)
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Auto-Routing (Enterprise)" icon="route" href="/ai/auto-routing">
  ...
  <Card title="Priority Detection" icon="flag" href="/ai/priority-detection">
    AI analyzes tickets and sets priority levels (low, medium, high, urgent).
  </Card>
  ...
  <Card title="Translation (Enterprise)" icon="globe" href="/ai/translation">
...
<Tip>
  Tokens reset monthly, aligned with your billing period. You can monitor usage in **AI Usage** in the dashboard sidebar.
</Tip>
...
- **AI Usage** in the dashboard sidebar shows current usage
...
- **Knowledge Base** + **Tone Detection** = Calm AI responses for frustrated users
