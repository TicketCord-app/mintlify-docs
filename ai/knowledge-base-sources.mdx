...
<Steps>
  ...
  <Step title="Click Add Knowledge Source">
    Click the **Add Knowledge Source** button in the Sources section.
  </Step>
  <Step title="Fill in the Details">
    Enter the required information based on your source type.
  </Step>
  <Step title="Save the Source">
    Click **Save** to add the source. TicketCord automatically queues the first scan.
  </Step>
</Steps>
...
- **Pages to Read** - How many pages to scan: 1, 5, 10, 15, 20, 25, 50, 75, or 100 (up to 500 on Enterprise)

**How crawling works:**
1. The bot visits your starting URL
2. It finds all links on that page
3. It follows those links and scans each page
4. This continues until it reaches your page limit (100 on Pro, 500 on Enterprise)
...
<Warning>
  Larger page limits take longer to index. Start small and increase if needed.
</Warning>
...
| **Preparing** | Currently reading content; documentation sites show "Reading X/Y" progress |
| **Content saved** | Ready to use |
...
<Tip>
  Set **Auto-refresh** (daily, weekly, or monthly) if your content changes frequently. Discord channels and connected repositories can also sync in realtime.
</Tip>
