...
If you're an EU consumer, you have a **14-day withdrawal right** for digital goods, provided:
- You haven't waived this right during checkout
- You haven't started using the paid service features
