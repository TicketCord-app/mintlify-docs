...
<Info>
  Everyone sees the same list. Whether a command actually works for you depends on your role and the server's plan; see the tables in [Commands Overview](/commands/overview).
</Info>
...
<Info>
  The closed list shows the 15 most recent closed tickets.
</Info>
...
<CardGroup cols={2}>
  <Card title="Support Server" icon="discord" href="https://ticketcord.com/discord">
